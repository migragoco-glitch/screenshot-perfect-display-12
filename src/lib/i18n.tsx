...
export const en = {
  ...
  "pricing.stabFuture":
    "In later development stages — following the necessary coordination, contractual agreements, and relevant licenses/permits with the institutions involved — this package could connect you directly to the relevant service desk of each institution at every roadmap phase, including scheduling and assigning a responsible caseworker, and, with your explicit consent, make your information visible on that institution's staff dashboard. This corresponds to the planned Connect+ (B2B) and institutional dashboard (B2G) capabilities, to be developed only after the core product has been validated.",
