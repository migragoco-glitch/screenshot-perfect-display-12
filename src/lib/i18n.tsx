...
export const en = {
  ...
  "hero.discover2": "Your priorities",
  ...
  "hero.roadmapWeeks4": "Weeks 10-12",
  "hero.navigatorClosing": "From your profile to your roadmap — one product.",
  ...
  "q.corrupted": "We noticed an issue with your saved answers — please retake the assessment to continue.",
  ...
  "q.level": "Level",
  "q.levelProgress": "Level progress",
  "q.beginLevel": "Begin this level",
  "q.levelComplete": "complete — nice progress.",
  "q.companion.start": "Ready? Let's go through this together, step by step.",
  "q.companion.mid": "You're doing great — your profile is taking shape.",
  "q.companion.near": "Almost there — just a few more questions.",
  "q.levelDescription.1": "Begin with the personal and family details that shape your starting point.",
  "q.levelDescription.2": "Map your education, experience, and professional capabilities.",
  "q.levelDescription.3": "Review the financial foundation supporting your move.",
  "q.levelDescription.4": "Explore how prepared you feel to adapt and build connections.",
  "q.levelDescription.5": "Check your legal history and document readiness.",
  "q.levelDescription.6": "Clarify your intended destination pathway and timing.",
  "q.levelDescription.7": "Complete the optional context that sharpens your action plan.",
  ...
  "metrics.respTitle": "Individual feedback responses",
  "metrics.respBody":
    "Every submitted survey response, newest first. Includes the score, the free-text comment and the submission time.",
  "metrics.respLoad": "Load responses",
  "metrics.respNone": "No responses collected yet.",
  "metrics.respExport": "Download CSV",
  "metrics.respScore": "Score",
  "metrics.respComment": "Comment",
  "metrics.respWhen": "Submitted",
  "metrics.respCsat": "Accuracy check responses",
  "metrics.respPositive": "Accurate",
  "metrics.respNegative": "Not accurate",
...
export const fa: Record<keyof typeof en, string> = {
  ...
  "hero.sub":
    "میگراگو از یک ارزیابی هوشمند برای شناخت وضعیت فعلی و میزان آمادگی شما برای استقرار و ادغام در کشور مقصد استفاده می‌کند و سپس بر اساس قوانین، رویه‌ها، خدمات و منابع حمایتی مرتبط، یک نقشه‌راه ۱۲ هفته‌ای شخصی‌سازی‌شده برای شما ایجاد می‌کند.",
  ...
  "hero.roadmapWeeks4": "هفتهٔ ۱۰–۱۲",
  "hero.navigatorClosing": "از پروفایل شما تا نقشه‌راه شما — یک محصول.",

  "about.title": "میگراگو چیست",
  "about.definitionTitle": "تعریف",
  "about.definition":
    "یک راهنمای دیجیتال شخصی‌سازی‌شده که به شما کمک می‌کند وضعیت خود را درک کنید، اولویت‌هایتان را شناسایی کنید و بدانید برای استقرار و ادغام در کشور مقصد، قدم بعدی چیست.",
  ...
  "how.s1.d": "یک ارزیابی ساختاریافته، وضعیت فعلی و میزان آمادگی شما را در مسیر مهاجرت، از پیش از مهاجرت تا ورود، استقرار و ادغام، در سه بُعد و هفت سطح مشخص می‌کند.",
  "how.s2.t": "پروفایل هوشمند ادغام",
  "how.s2.d":
    "پاسخهای شما به یک پروفایل شخصی سازی شده تبدیل میشوند که نقاط قوت، شکافها و اولویتهای شما را نشان میدهد.",
  "how.s3.t": "نقشه‌راه ۱۲ هفته‌ای",
  "how.s3.d":
    "پروفایل شما به یک نقشه راه ۱۲ هفته‌ای تبدیل می‌شود تا گام‌های بعدی شما را دقیقاً منطبق با ضوابط و الزامات نهادهای مرتبط هدایت کند.",
  ...
  "q.corrupted": "مشکلی در پاسخ‌های ذخیره‌شدهٔ شما پیدا شد — لطفاً پرسشنامه را دوباره تکمیل کنید.",
  ...
  "set.placeholderNote": "این متن حاضر صرفاً بیانگر سیاست حریم خصوصی و شرایط استفاده از این نرم‌افزار است و نباید آن را به‌عنوان رای، نظریه یا مشاوره رسمی حقوقی تلقی کرد.",
  ...
  "privacy.body":
    "میگراگو به حریم خصوصی شما اهمیت می‌دهد. در نسخهٔ فعلی محصول (MVP): پاسخ‌های ارزیابی شما فقط در مرورگرتان ذخیره می‌شوند و به سرورهای ما ارسال نمی‌شوند. نشانی رایانامه‌ای که برای اطلاع‌رسانی دسترسی زودهنگام ثبت می‌کنید، به‌صورت ایمن نگهداری و تنها برای همین هدف استفاده می‌شود. بازخوردهایی که ارسال می‌کنید بدون هیچ اطلاعات شناسایی‌کننده ذخیره می‌شوند. هر زمان بخواهید، می‌توانید داده‌های محلی خود را از بخش تنظیمات مرورگر حذف کنید. این سیاست هم‌زمان با تکمیل بخش‌های پولی و سیستم حساب کاربری میگراگو، با نسخه‌ای جامع‌تر و منطبق با الزامات GDPR جایگزین خواهد شد.\u00a0",
  ...
  "about.processBody":
    "ادغام اجتماعی یک اقدام تک‌مرحله‌ای نیست، بلکه یک مسیر پیوسته است. نیازها و اولویت‌های شما در طول مراحل پیش از مهاجرت، ورود، استقرار و سازگاری با ساختارهای حقوقی، اقتصادی و اجتماعی تحول می‌یابند. میگراگو در هر گام، وضعیت شما را می‌سنجد و دقیق‌ترین اقدام بعدی را منطبق با ضوابط و رویه‌های نهادهای مرتبط مشخص می‌کند.",
  ...
  "q.level": "سطح",
  "q.levelProgress": "پیشرفت سطح‌ها",
  "q.beginLevel": "شروع این سطح",
  "q.levelComplete": "تکمیل شد — پیشرفت خوبی داشتید.",
  "q.companion.start": "آماده‌اید؟ بیایید قدم‌به‌قدم با هم پیش برویم.",
  "q.companion.mid": "عالی پیش می‌روید — پروفایل شما در حال شکل‌گرفتن است.",
  "q.companion.near": "تقریباً تمام شد — فقط چند سؤال دیگر مانده.",
  "q.levelDescription.1": "با اطلاعات فردی و خانوادگی که نقطهٔ شروع شما را شکل می‌دهد آغاز کنید.",
  "q.levelDescription.2": "تحصیلات، تجربه و توانمندی‌های حرفه‌ای خود را مشخص کنید.",
  "q.levelDescription.3": "پایهٔ مالی پشتیبان جابه‌جایی خود را مرور کنید.",
  "q.levelDescription.4": "آمادگی خود برای سازگاری و ایجاد ارتباط را بررسی کنید.",
  "q.levelDescription.5": "سابقهٔ حقوقی و آمادگی مدارک خود را بررسی کنید.",
  "q.levelDescription.6": "مسیر مقصد و زمان‌بندی موردنظر خود را روشن کنید.",
  "q.levelDescription.7": "اطلاعات اختیاری تکمیلی برای دقیق‌تر شدن برنامهٔ اقدام را تکمیل کنید.",
  ...
  "faq.a4":
    "پاسخ‌های ارزیابی شما، وضعیت کنونی‌تان را در ابعاد سه‌گانه سنجیده و شکاف‌های موجود را شناسایی می‌کند. سامانه سپس این شکاف‌ها را با ضوابط و رویه‌های رسمی کشور مقصد تطبیق داده و اقدامات لازم را در قالب یک برنامه ۱۲ هفته‌ای (در چهار فاز عملیاتی) مرتب می‌سازد.",
  ...
  "metrics.respTitle": "پاسخ‌های تک‌به‌تک بازخورد",
  "metrics.respBody":
    "همهٔ پاسخ‌های ثبت‌شدهٔ نظرسنجی، از جدیدترین. شامل امتیاز، متن نظر و زمان ثبت.",
  "metrics.respLoad": "بارگذاری پاسخ‌ها",
  "metrics.respNone": "هنوز پاسخی ثبت نشده است.",
  "metrics.respExport": "دانلود CSV",
  "metrics.respScore": "امتیاز",
  "metrics.respComment": "نظر",
  "metrics.respWhen": "زمان ثبت",
  "metrics.respCsat": "پاسخ‌های بررسی دقت",
  "metrics.respPositive": "دقیق",
  "metrics.respNegative": "دقیق نبود",
