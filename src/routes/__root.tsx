  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MigraGo — SettleSmart Navigator for Finland" },
      {
        ...
        content: "Assess your readiness and get an institution-sourced 12-week roadmap for Finland.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700;800&family=Vazirmatn:wght@400;500;600;700;800&display=swap",
      },
